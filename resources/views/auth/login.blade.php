  ...
  <div class="row">
    ...
    <div class="container main-login">
      ...
      <div class="card-form col-md-6 col-md-offset-3">
        ...
        <form role="form" method="POST" class="col-md-10 col-md-offset-1" action="{{ url('/peticion') }}">
          {{ csrf_field() }}
          <div class="login_wrapper">

          <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
            <input type="number" maxlength="10" class="form-control" placeholder="Número celular (10 dígitos)"
          ...
          <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
            <input type="password" maxlength="9" class="form-control" placeholder="Contraseña"
          ...
          <div>
            <div class="text-center">
              <button id="login" type="submit" class="btn btn-fill btn-warning btn-wd" style="background: rgb(12, 172, 0); border: none;"><i class="fa fa-sign-in" aria-hidden="true"></i> Generar Token</button>
            </div>
        ...
        <div class="information-login">
          <p class="center-align">
            <a class="reset_pass" href="{{ url('/resetear-contrasena')}}">¿Olvidó su clave?</a><br><br>
            PayApp la nueva manera de hacer crecer tu negocio.
          </p>
        </div>
      </div>
